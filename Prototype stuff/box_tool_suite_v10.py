...
_TOOLTIPS = {
    "ID":           "Item ID number. Must be unique in the XML table.",
    "Class":        "Item class: 1=Item, 2=Equipment, 3=Drill.",
    "Type":         "Item type category (Sword, Hat, Potions, Boxes, etc.).",
    "SubType":      "Sub-category of the item type. 0 = N/A.",
    "ItemFType":    "Stat affinity: 0=N/A, 1=Power, 2=Magic, 3=Sense, 4=Charm, 5=Neutral.",
    "Name":         "The name displayed in-game.",
    "Comment":      "The description displayed in-game.",
    "Use":          "The purpose of the item shown in-game.",
    "Name_Eng":     "Dev notes, e.g. for localization. Usually a space.",
    "Comment_Eng":  "May contain references or 'description coming soon'. Usually a space.",
    "FileName":     "Path to the item sprite NRI file (e.g. data\\item\\itm000.nri).",
    "BundleNum":    "Sprite index within the NRI file. Starts at 0; check Animations tab (+1 offset).",
    "InvFileName":  "Same as FileName — copied automatically.",
    "InvBundleNum": "Same as BundleNum — copied automatically.",
    "CmtFileName":  "Path to the illustration NRI file (e.g. data\\item\\itm_illu000.nri).",
    "CmtBundleNum": "Illustration sprite index within the CmtFileName NRI.",
    "EquipFileName":"Points to the equipment/drill model file. Leave blank (space) if not equipment.",
    "PivotID":      "Source item ID reference. Used for equipment with different levels/options.",
    "PaletteId":    "Palette ID. Leave at 0 for most items.",
    "Options":      "Item option flags (Not Buyable, Not Sellable, CM, etc.). Maps to eItemOption.",
    "HideHat":      "Per-character-type flag for hiding ears when equipping.",
    "ChrTypeFlags": "Character-type restrictions/events. Sum of flags per race and job tier.",
    "GroundFlags":  "Leave at 0. Non-zero may have unintended consequences.",
    "SystemFlags":  "Leave at 0. Non-zero may have unintended consequences.",
    "OptionsEx":    "Extended options — random stat range, elemental, boss set, etc.",
    "Weight":       "Item weight value (WT stat).",
    "Value":        "Galder (in-game currency) price tag.",
    "MinLevel":     "Minimum level required to use or equip the item.",
    "Effect":       "Result after use (Open Box=22, Portable Port=14, Hair Dye=15, etc.).",
    "EffectFlags2": "Leave at 0.",
    "SelRange":     "Leave at 0 except for Beta Magic Cards.",
    "Life":         "Timed/limited item duration, or drill life span.",
    "Depth":        "For test drills. Leave at 0.",
    "Delay":        "Tied to Beta Magic Cards. Leave at 0.000000.",
    "AP":           "Gun/Throwing Attack Power (not the regular AP stat).",
    "HP":           "Amount of HP recovered (potions etc.).",
    "HPCon":        "Amount of HP consumed on use.",
    "MP":           "Amount of MP recovered.",
    "MPCon":        "Amount of MP consumed. Also used for Card MP values.",
    "Money":        "Amount of Galder obtained (coupons).",
    "APPlus":       "Attack Power bonus stat.",
    "ACPlus":       "Accuracy bonus stat.",
    "DXPlus":       "Dexterity bonus stat.",
    "MaxMPPlus":    "Max Magic Point bonus stat.",
    "MAPlus":       "Magic Attack bonus stat.",
    "MDPlus":       "Magic Defense bonus stat.",
    "MaxWTPlus":    "Max Weight bonus stat.",
    "DAPlus":       "Detect Ability bonus stat.",
    "LKPlus":       "Luck bonus stat.",
    "MaxHPPlus":    "Max Health Point bonus stat.",
    "DPPlus":       "Defense Power bonus stat.",
    "HVPlus":       "Evasion bonus stat.",
    "HPRecoveryRate":"HP regen rate (from pets). Format: 0.000000.",
    "MPRecoveryRate":"MP regen rate (from pets). Format: 0.000000.",
    "CardNum":      "Card rank (0=none, 1=Boss, 9=NPCs). Controls life, grade access.",
    "CardGenGrade": "Which grade ranges are allowed for this card.",
    "CardGenParam": "Skill cards use 7/0/0.000000. Star cards span 1-9.",
    "DailyGenCnt":  "Possibly a daily card-battle limit.",
    "PartFileName": "ItemParamCM2 only — points to fashion item model.",
    "ChrFTypeFlag": "Leave at 0.",
    "ChrGender":    "Leave at 0.",
    "ExistType":    "Items that cannot stack (sprints, boosters). 0=off, 1=timer enabled.",
    "Ncash":        "Cash shop price tag (MyShop currency).",
    "NewCM":        "Leave at 0.",
    "FamCM":        "Leave at 0.",
    "Summary":      "Leave blank (space).",
    "ShopFileName": "Points to promotional Cash Mall item image.",
    "ShopBundleNum":"Animation sprite index for ShopFileName (same NRI method as BundleNum).",
    "MinStatType":  "Stat type required to equip: 0=AP, 4=MA, 7=DA.",
    "MinStatLv":    "Minimum stat value required. 0 = no requirement shown.",
    "RefineIndex":  "References RefineLevelTable. See reference table.",
    "RefineType":   "Equipment type category for refining.",
    "CompoundSlot": "Number of compound slots (0-5). Higher values will cause UI errors.",
    "SetItemID":    "Equipment set ID reference.",
    "ReformCount":  "Reform count (possibly tied to skins).",
    "GroupId":      "Group ID. Leave at 0.",
}
...
def build_generic_itemparam_row(cfg):
    ...
    lines = [
        ...
        f"<Effect>{_int(cfg.get('effect',0))}</Effect>",
...
class Tool6(tk.Frame):
    ...
    def _build_editor(self):
        ...
        # Outer wrapper — header / scroll / footer
        wrap = tk.Frame(self, bg=BG)
        wrap.pack(fill="both", expand=True)
        wrap.grid_rowconfigure(0, weight=0)
        wrap.grid_rowconfigure(1, weight=1)
        ...
        # Reference tables button (top-right of header)
        ...
        def sec(title): return mk_section(C, title)
        def lbl_entry(parent, label, var, width=30, tip=None):
            ...
            if tip: _attach_tooltip(lw, tip); _attach_tooltip(ent, tip)
            return ent
        def lbl_note(parent, text):
            tk.Label(parent, text=text, bg=BG, fg=FG_GREY,
                     font=("Consolas", 8)).pack(anchor="w", padx=10, pady=(2,0))

        # ── Helper: dropdown + raw-value box pair ─────────────────────────
        def dropdown_row(parent, label, mapping, raw_var, tip=None, width=38):
            """Shows label | [dropdown] | raw entry box side by side."""
            r = tk.Frame(parent, bg=BG); r.pack(fill="x", padx=8, pady=2)
            lw = tk.Label(r, text=label, width=22, anchor="w", bg=BG, fg=FG,
                          font=("Consolas", 9)); lw.pack(side="left")
            values_dd = [f"{v} — {d}" for v,d in mapping]
            combo = ttk.Combobox(r, values=values_dd, state="readonly",
                                 width=width, font=("Consolas", 9))
            combo.pack(side="left", padx=4)
            raw_ent = tk.Entry(r, textvariable=raw_var, width=7, bg=BG3, fg=FG,
                               insertbackground=FG, font=("Consolas", 9), relief="flat")
            ...
            def _dd_change(e):
                sel = combo.current()
                if sel >= 0:
                    raw_var.set(str(mapping[sel][0]))
            combo.bind("<<ComboboxSelected>>", _dd_change)
            # Sync: raw -> dropdown (match if known value)
            def _raw_change(*_):
                val = raw_var.get().strip()
                for i, (v, _) in enumerate(mapping):
                    if str(v) == val:
                        combo.set(values_dd[i]); return
                combo.set("")   # no match — clear dropdown
            raw_var.trace_add("write", _raw_change)
            # Initialise dropdown to match saved value
            _raw_change()
            if tip:
        ...
        # ── First-run welcome banner (only shown when no saved settings) ─────
        if self._first_run:
            ...
            tk.Label(wb, text=(
                "All fields are pre-filled with safe defaults.\n"
                "Hover any label or entry for a description of that field.\n"
                "Class and Type default to Unselected — set them before generating.\n"
                "SubType and ItemFType default to 0 (N/A).\n"
                "Your settings are remembered between sessions.\n"
                "Click 📖 Field Reference for lookup tables."),
        ...
        # ── Mode toggle (dropdown vs manual) ─────────────────────────────
        ...
        tk.Label(mode_frm, text="Input mode:", bg=BG, fg=FG_DIM,
                 font=("Consolas", 9)).pack(side="left")
        for lbl, val in [("Dropdown", "dropdown"), ("Manual", "manual")]:
            tk.Radiobutton(mode_frm, text=lbl, variable=mode_var, value=val,
                           bg=BG, fg=FG, selectcolor=BG3, activebackground=BG,
                           font=("Consolas", 9)).pack(side="left", padx=8)
        ...
        if _default_id == "1": _default_id = s.get("id","")  # don't override empty with 1
        ...
        lbl_entry(s1, "ID:", v_id, width=14, tip=_TOOLTIPS["ID"])

        # Class / Type — dropdowns + raw boxes
        # Manual rows (shown when mode=manual)
        ...
        def _build_dd_row(parent, label, mapping, var, tip):
            ...
            def _raw_ch(*_):
                val = var.get().strip()
                for i, (v, _) in enumerate(mapping):
                    if str(v) == val: combo.set(values_dd[i]); return
                combo.set("")
            var.trace_add("write", _raw_ch); _raw_ch()
            if tip: _attach_tooltip(lw, tip); _attach_tooltip(combo, tip); _attach_tooltip(raw_ent, tip)
            return combo
        ...
        _build_dd_row(dd_class_frm,  "Class:", _CLASS_MAP,    v_class, _TOOLTIPS["Class"])
        _build_dd_row(dd_type_frm,   "Type:",  _TYPE_MAP,     v_type,  _TOOLTIPS["Type"])
        ...
        lbl_note(s1, "  Hover any label for field description.  SubType and ItemFType default to 0.")
        ...
        lbl_note(s3,  "  InvFileName/InvBundleNum auto-copied from above.")
        ...
        lbl_note(s3,  "  Leave EquipFileName as a single space if not equipment/drill.")

        # ── Section 4: Options ────────────────────────────────────────────
        s4 = sec("  Options  ")
        lbl_note(s4, "  Hover any checkbox for the flag value. Bitmask is computed automatically.")
        opts_vars = [tk.BooleanVar(value=bool(s.get("options_flags",[False]*len(_OPTIONS_FULL))[i]
                                              if i < len(s.get("options_flags",[])) else False))
                     for i in range(len(_OPTIONS_FULL))]
        opt_chk_frm = tk.Frame(s4, bg=BG); opt_chk_frm.pack(fill="x", padx=8, pady=4)
        for i, (fval, flbl) in enumerate(_OPTIONS_FULL):
            cb = tk.Checkbutton(opt_chk_frm, text=flbl, variable=opts_vars[i],
                                bg=BG, fg=FG, selectcolor=BG3, activebackground=BG,
                                font=("Consolas", 8))
            cb.grid(row=i // 4, column=i % 4, sticky="w", padx=6, pady=1)
            _attach_tooltip(cb, f"Flag value: {fval}  —  {flbl}")
        # Live bitmask preview
        opt_preview = tk.Label(s4, text="Bitmask: 0", bg=BG, fg=GREEN,
                               font=("Consolas", 9))
        ...
        # ── Section 5: OptionsEx ─────────────────────────────────────────
        s5 = sec("  OptionsEx  ")
        v_optex_raw = tk.StringVar(value=str(s.get("options_ex", 0)))
        lbl_note(s5, "  Select known flags or enter a raw value. Values OR together.")
        optex_vars = {}
        optex_frm = tk.Frame(s5, bg=BG); optex_frm.pack(fill="x", padx=8, pady=4)
        for i, (fval, fdesc) in enumerate(_OPTIONSEX_MAP):
            if fval == 0: continue
            v = tk.BooleanVar()
            cb = tk.Checkbutton(optex_frm, text=f"{fval} — {fdesc}", variable=v,
                                bg=BG, fg=FG, selectcolor=BG3, activebackground=BG,
                                font=("Consolas", 8))
            cb.grid(row=(i-1)//2, column=(i-1)%2, sticky="w", padx=6, pady=1)
            _attach_tooltip(cb, f"Flag: {fval}  —  {fdesc}")
            optex_vars[fval] = v
        r_optex = tk.Frame(s5, bg=BG); r_optex.pack(fill="x", padx=8, pady=(2,4))
        tk.Label(r_optex, text="Raw value:", bg=BG, fg=FG_DIM,
                 font=("Consolas", 9)).pack(side="left")
        optex_raw_ent = tk.Entry(r_optex, textvariable=v_optex_raw, width=10,
                                 bg=BG3, fg=FG, insertbackground=FG,
                                 font=("Consolas", 9), relief="flat")
        optex_raw_ent.pack(side="left", padx=6)
        _attach_tooltip(optex_raw_ent, _TOOLTIPS["OptionsEx"])
        ...
        # ── Section 6: ChrTypeFlags ──────────────────────────────────────
        s6 = sec("  ChrTypeFlags  ")
        v_chr_raw = tk.StringVar(value=str(s.get("chr_type_flags", 0)))
        lbl_note(s6, "  Select character + job tier, or enter raw bitmask.")
        ...
        chr_lb = tk.Listbox(chr_lb_frm, height=4, width=36, bg=BG3, fg=FG,
                            font=("Consolas", 9), selectbackground=BG4,
                            activestyle="none")
        chr_lb.pack(anchor="w")
        ...
        # Init from saved raw value
        saved_chr = s.get("chr_type_flags", 0)
        for v in sorted(CHR_FLAG_MAP.values()):
            if saved_chr & v: chr_selected6.append(v)
        _refresh_chr6()

        # ── Section 7: Misc flags ─────────────────────────────────────────
        s7 = sec("  Misc Flags  ")
        ...
        # GroundFlags / SystemFlags — warn if non-zero (uses FocusOut bind)
        def _attach_warn_nonzero(entry_widget, fname):
            """Warn when a should-be-zero field is set non-zero on focus-out."""
            def _cb(e):
        ...
        lbl_entry(s7, "HideHat:", v_hide_hat, 10, _TOOLTIPS["HideHat"])
        gnd_ent = lbl_entry(s7, "GroundFlags:", v_ground, 10, _TOOLTIPS["GroundFlags"])
        sys_ent = lbl_entry(s7, "SystemFlags:", v_system, 10, _TOOLTIPS["SystemFlags"])
        lbl_entry(s7, "PivotID:", v_pivot, 10, _TOOLTIPS["PivotID"])
        lbl_entry(s7, "PaletteId:", v_palette, 10, _TOOLTIPS["PaletteId"])
        lbl_entry(s7, "ExistType:", v_exist_type, 10, _TOOLTIPS["ExistType"])
        lbl_note(s7, "  GroundFlags and SystemFlags should remain 0.")
        _attach_warn_nonzero(gnd_ent, "GroundFlags")
        _attach_warn_nonzero(sys_ent, "SystemFlags")

        # ── Section 8: Numeric Stats ──────────────────────────────────────
        s8 = sec("  Numeric Stats  ")
        _num_fields = [
            ("Weight:", "weight", "1"), ("Value:", "value", "0"),
            ("MinLevel:", "min_level", "1"), ("Money:", "money", "0"),
            ("Ncash:", "ncash", "0"),
        ]
        _stat_fields = [
            ("AP:", "ap"), ("HP:", "hp"), ("HPCon:", "hpcon"),
            ("MP:", "mp"), ("MPCon:", "mpcon"),
            ("APPlus:", "applus"), ("ACPlus:", "acplus"), ("DXPlus:", "dxplus"),
            ("MaxMPPlus:", "maxmpplus"), ("MAPlus:", "maplus"),
            ("MDPlus:", "mdplus"), ("MaxWTPlus:", "maxwtplus"),
            ("DAPlus:", "daplus"), ("LKPlus:", "lkplus"),
            ("MaxHPPlus:", "maxhpplus"), ("DPPlus:", "dpplus"), ("HVPlus:", "hvplus"),
        ]
        num_vars = {}
        nr = tk.Frame(s8, bg=BG); nr.pack(fill="x", padx=8, pady=4)
        for ci, (lbl, key, dflt) in enumerate(_num_fields):
            v = tk.StringVar(value=str(s.get(key, dflt)))
            num_vars[key] = v
            tk.Label(nr, text=lbl, bg=BG, fg=FG, font=("Consolas", 9),
                     width=10, anchor="w").grid(row=0, column=ci*2, padx=3)
            ent = tk.Entry(nr, textvariable=v, width=10, bg=BG3, fg=FG,
                           insertbackground=FG, font=("Consolas", 9), relief="flat")
            ent.grid(row=0, column=ci*2+1, padx=3)
            tip_key = {"weight":"Weight","value":"Value","min_level":"MinLevel",
                       "money":"Money","ncash":"Ncash"}.get(key, key)
            if tip_key in _TOOLTIPS:
                _attach_tooltip(ent, _TOOLTIPS[tip_key])
        stat_frm = tk.Frame(s8, bg=BG); stat_frm.pack(fill="x", padx=8, pady=4)
        for i, (lbl, key) in enumerate(_stat_fields):
            v = tk.StringVar(value=str(s.get(key, "0")))
            num_vars[key] = v
            tk.Label(stat_frm, text=lbl, bg=BG, fg=FG, font=("Consolas", 9),
                     width=10, anchor="w").grid(row=i//4, column=(i%4)*2, padx=3, pady=1)
            ent = tk.Entry(stat_frm, textvariable=v, width=8, bg=BG3, fg=FG,
                           insertbackground=FG, font=("Consolas", 9), relief="flat")
            ent.grid(row=i//4, column=(i%4)*2+1, padx=3, pady=1)
            tip_key = lbl.rstrip(":").replace("+","Plus")
            if tip_key in _TOOLTIPS: _attach_tooltip(ent, _TOOLTIPS[tip_key])
        # Float fields
        ...
        for ci, (lbl, key) in enumerate([
            ...
            ("Delay:", "delay"), ("CardGenParam:", "cardgenparam")
        ]):
            v = tk.StringVar(value=str(s.get(key, "0")))
            num_vars[key] = v
            tk.Label(f_frm, text=lbl, bg=BG, fg=FG_DIM, font=("Consolas", 9),
                     width=12, anchor="w").grid(row=0, column=ci*2, padx=3)
            ent = tk.Entry(f_frm, textvariable=v, width=12, bg=BG3, fg=FG,
                           insertbackground=FG, font=("Consolas", 9), relief="flat")
            ent.grid(row=0, column=ci*2+1, padx=3)
            tip_key = {"hprecoveryrate":"HPRecoveryRate","mprecoveryrate":"MPRecoveryRate",
                       "delay":"Delay","cardgenparam":"CardGenParam"}.get(key, "")
            if tip_key in _TOOLTIPS: _attach_tooltip(ent, _TOOLTIPS[tip_key])
        lbl_note(s8, "  Float fields (HPRecovery, MPRecovery, Delay, CardGenParam) auto-formatted to 6 decimals.")

        # ── Section 9: Effect & single-value dropdowns ───────────────────
        s9 = sec("  Effect & Lookup Fields  ")
        lbl_note(s9, "  Hover labels for reference tables. Raw entry syncs with dropdown.")
        v_effect      = tk.StringVar(value=str(s.get("effect", 0)))
        ...
        def _dd_row9(parent, label, mapping, raw_var, tip_key=""):
            r = tk.Frame(parent, bg=BG); r.pack(fill="x", padx=8, pady=2)
            ...
            def _sel(e):
                sel = combo.current()
                if sel >= 0: raw_var.set(str(mapping[sel][0]))
            combo.bind("<<ComboboxSelected>>", _sel)
            def _raw(*_):
                val = raw_var.get().strip()
                for i,(v,_) in enumerate(mapping):
                    if str(v)==val: combo.set(vals_dd[i]); return
                combo.set("")
            raw_var.trace_add("write",_raw); _raw()
            if tip: _attach_tooltip(lw,tip); _attach_tooltip(combo,tip); _attach_tooltip(raw_ent,tip)

        _dd_row9(s9, "Effect:", _EFFECT_MAP, v_effect, "Effect")
        _dd_row9(s9, "RefineIndex:", _REFINEINDEX_MAP, v_refine_idx, "RefineIndex")
        _dd_row9(s9, "RefineType:", _REFINETYPE_MAP, v_refine_type, "RefineType")
        _dd_row9(s9, "MinStatType:", _MINSTATTYPE_MAP, v_minstattype, "MinStatType")
        lbl_entry(s9, "MinStatLv:", v_minstatLv, 8, _TOOLTIPS["MinStatLv"])
        lbl_entry(s9, "Life:", v_life, 8, _TOOLTIPS["Life"])
        lbl_entry(s9, "CardNum:", v_cardnum, 8, _TOOLTIPS["CardNum"])
        lbl_entry(s9, "CardGenGrade:", v_cardgrade, 8, _TOOLTIPS["CardGenGrade"])
        lbl_entry(s9, "DailyGenCnt:", v_daily, 8, _TOOLTIPS["DailyGenCnt"])
        lbl_entry(s9, "CompoundSlot:", v_compound, 8, _TOOLTIPS["CompoundSlot"])
        lbl_entry(s9, "SetItemID:", v_setitem, 8, _TOOLTIPS["SetItemID"])
        lbl_entry(s9, "ReformCount:", v_reform, 8, _TOOLTIPS["ReformCount"])
        lbl_entry(s9, "GroupId:", v_group, 8, _TOOLTIPS["GroupId"])
        lbl_entry(s9, "SelRange:", v_sel_range, 8, _TOOLTIPS["SelRange"])
        lbl_entry(s9, "EffectFlags2:", v_eff2, 8, _TOOLTIPS["EffectFlags2"])
        lbl_entry(s9, "Depth:", v_depth, 8, _TOOLTIPS["Depth"])
        lbl_entry(s9, "ShopFileName:", v_shopfn, 50, _TOOLTIPS["ShopFileName"])
        lbl_entry(s9, "ShopBundleNum:", v_shopbn, 8, _TOOLTIPS["ShopBundleNum"])
        lbl_entry(s9, "PartFileName:", v_partfn, 50, _TOOLTIPS["PartFileName"])
        ...
        def _gather():
            """Collect all field values into a cfg dict."""
            return {
                "id":           v_id.get().strip(),
        ...
        def _generate():
            ...
            # Check if type 15 (box) — ask about PresentItemParam
            try: type_val_i = int(cfg.get("type_val", 0))
            except: type_val_i = 0
            try: effect_val_i = int(cfg.get("effect", 0))
            except: effect_val_i = 0
            present_xml = None

            if type_val_i == 15:
                if effect_val_i != 22:
                    messagebox.showwarning("Box Effect Warning",
                        "This item has Type 15 (Useables/Boxes) but Effect is not 22 (Open Box).\n"
                        "The box cannot be opened without Effect=22.\n\n"
                        "Go back and set Effect to 22, or continue if intentional.")
                want_present = messagebox.askyesno("PresentItemParam2",
                    "This appears to be a box (Type 15).\n"
                    "Would you like to also generate a PresentItemParam2 row\n"
                    "(defines what drops from the box)?")
                if want_present:
        ...
        def _clear_for_next():
            # Bump ID by 1, keep everything else
            cfg = _gather()
        ...
        def _generate_and_next():
            ...
            if not cfg["id"].strip():
                messagebox.showerror("Missing ID", "Please enter an Item ID."); return
            xml = build_generic_itemparam_row(cfg)
            # Bump ID for next item, save settings
            try:    cfg["id"] = str(int(cfg["id"]) + 1)
            except: pass
            _save_t6_settings(cfg)
            self._settings = cfg
            # Show output then immediately prepare next editor
            self._show_output(xml, cfg, auto_next=True, present_xml=None)

        mk_btn(nav, "⚡  Generate XML Row", _generate, color=self.ACC, fg=BG2,
               font=("Consolas", 11, "bold")).pack(side="left", padx=14, pady=6)
        mk_btn(nav, "➕  Generate & Next ID", _generate_and_next,
               color=GREEN, fg=BG2).pack(side="left", padx=4, pady=6)
        mk_btn(nav, "🗑  Clear / Reset", self._reset, color=BG4).pack(
    ...
    def _show_reference(self):
        """Open a scrollable reference window with all lookup tables."""
        win = tk.Toplevel(self.root)
        win.title("ItemParam Field Reference")
        win.geometry("860x680")
        win.configure(bg=BG)
        sh = tk.Frame(win, bg=BG); sh.pack(fill="both", expand=True)
        canv, cont = mk_scroll_canvas(sh, init_width=820)

        def rsec(title):
            f = tk.Frame(cont, bg=BG2, pady=4)
            f.pack(fill="x", padx=8, pady=(8,2))
            tk.Label(f, text=title, bg=BG2, fg=BLUE,
            ...
            if cols:
                for ci, c in enumerate(cols):
                    tk.Label(frm, text=c, bg=BG2, fg=BLUE,
                             font=("Consolas",8,"bold"), width=max(10,len(c)+2),
            ...
            for ri, row in enumerate(rows):
                ...
                for ci, cell in enumerate(row):
                    tk.Label(frm, text=str(cell), bg=bg, fg=FG,
                             font=("Consolas",8), width=max(10,len(str(cell))+2),
                             anchor="w").grid(row=ri+(1 if cols else 0), column=ci,
                                              padx=2, pady=1, sticky="w")

        def rnote(parent, text):
            tk.Label(parent, text=text, bg=BG, fg=FG_GREY,
                     font=("Consolas",8), justify="left", wraplength=780).pack(
                     anchor="w", padx=4, pady=(1,4))

        # Class
        s = rsec("Class"); rtable(s, _CLASS_MAP, ["Value","Description"])
        # Type
        s = rsec("Type"); rtable(s, _TYPE_MAP, ["Value","Description"])
        # SubType
        s = rsec("SubType (ItemParamCM2 marked with >)")
        rtable(s, _SUBTYPE_MAP, ["Value","Description"])
        # ItemFType
        s = rsec("ItemFType"); rtable(s, _ITEMFTYPE_MAP, ["Value","Description"])
        # Options
        s = rsec("Options (eItemOption flags — values OR together)")
        rtable(s, _OPTIONS_FULL, ["Flag Value","Description"])
        # OptionsEx
        s = rsec("OptionsEx (flags OR together)")
        rtable(s, _OPTIONSEX_MAP, ["Flag Value","Description"])
        rnote(s, "Values can be combined. Example: 1/2 = random stat + elemental.")
        # Effect
        s = rsec("Effect"); rtable(s, _EFFECT_MAP, ["Value","Description"])
        # RefineIndex
        s = rsec("RefineIndex"); rtable(s, _REFINEINDEX_MAP, ["Value","Description"])
        # RefineType
        s = rsec("RefineType"); rtable(s, _REFINETYPE_MAP, ["Value","Description"])
        # MinStatType
        s = rsec("MinStatType"); rtable(s, _MINSTATTYPE_MAP, ["Value","Description"])
        # CardNum
        s = rsec("CardNum — Rank reference")
        rtable(s, [
            (0,"None","None","Dummy/invalid/basic","Lowest"),
            (1,"Boss Cards","6","Scaling",""),
            (2,"High Tier","5","",""),
            (3,"Low-mid","4","",""),
            (4,"Mid","4","",""),
            (5,"High-low Monster","","",""),
            ...
            (8,"Low Monster","3","",""),
            (9,"NPCs","3","","Highest"),
        ], ["CardNum","Typical Target","Life","Grade","Fortune Rank Note"])
        rnote(s, "Life by rank: Rank 1=5-6 life  |  Rank 2/3/13/14=4-5 life  |  Rank 4-6/10-12=4 life  |  Rank 7-9=3 life  |  CardNum 7, GenGrade 0, GenParam 0.000000 for skill cards.")
        # ChrTypeFlags
        s = rsec("ChrTypeFlags — per character per job tier")
        rtable(s, [
            ("Bunny",1,512,262144), ("Buffalo",2,1024,524288),
            ("Sheep",4,2048,1048576), ("Dragon",8,4096,2097152),
            ("Fox",16,8192,4194304), ("Lion",32,16384,8388608),
            ("Cat",64,32768,16777216), ("Raccoon",124,65536,33554432),
            ("Paula",256,131072,67108864),
        ], ["Character","1st Job","2nd Job","3rd Job"])
        rnote(s, "Sum the flags for every character/job that should have access.")
        # ExistType
        s = rsec("ExistType"); rnote(s, "0 = disabled  |  1 = timer/cannot stack (sprints, boosters, etc.)")
        # Misc notes
        s = rsec("BundleNum / InvBundleNum / ShopBundleNum note")
        rnote(s,
            "Open the NRI file in NRI Viewer → Animations tab.\n"
            "The BundleNum starts at 0, but in the viewer count from 1.\n"
            "Example: BundleNum 9 → look at animation slot 10 in the viewer.")
