...
def build_generic_itemparam_row(cfg):
    ...
    # OptionsEx — slash-separated flags (like Options)
    _optex_raw = cfg.get("options_ex", 0)
    try: _optex_int = int(_optex_raw)
    except: _optex_int = 0
    # Decompose into individual flags present in _OPTIONSEX_MAP
...
class CombinedApp(tk.Tk):
    def __init__(self):
        ...
        # Set size, minimum size, and force the window manager to honour it
