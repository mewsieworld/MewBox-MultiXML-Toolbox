...
def build_presentparam_row(box_id, items, ptype, drop_cnt, default_rate, item_cnts=None):
    is_distrib      = (ptype == 2)
...
class Tool1(tk.Frame):
    ...
    def _build_output_screen(self):
        ...
        for cfg in self.box_configs:
            ...
            presentparam_rows.append(build_presentparam_row(cfg["id"],items_with_rates,cfg["present_type"],drop_cnt,default_rate,item_cnts=item_cnts))
