...
class Tool2(tk.Frame):
    ...
    def _build_load_screen(self):
        self._clear()
        # Scrollable wrapper so nothing gets cut off
        ...
        self = tk.Frame(_canv, bg=BG)
        _cw = _canv.create_window((0,0), window=self, anchor="nw")
        self.bind("<Configure>", lambda e: _canv.configure(scrollregion=_canv.bbox("all")))
        ...
        rw_sec = mk_section(self, "  Step 5 — Rewrite Box Parameters  (optional)  ")
