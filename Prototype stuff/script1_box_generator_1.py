...
class BoxGeneratorApp(tk.Tk):
    ...
    def _build_output_screen(self):
        ...
        def make_tab(title, lines, fname):
            ...
            br = tk.Frame(frm, bg="#1e1e2e"); br.pack(fill="x")
            tk.Button(br, text="📋 Copy All", command=copy_all,
                      bg="#313244", fg="#cdd6f4", font=("Consolas",9),
                      relief="flat", padx=10, pady=4).pack(side="left", padx=6, pady=4)
            tk.Button(br, text="💾 Save As…", command=save_file,
